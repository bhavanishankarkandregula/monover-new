...
function FilePreview2(props) {
 console.log("props",props);
  ...
  return (
    //   <Col>
    //   <Row>
    <div style={{width:'178px',marginLeft:'4px',marginRight:'4px',marginBottom:'23px',backgroundColor: "rgba(243, 242, 242, 0.7)", height: "49px", border: "1px solid lightgrey", borderRadius: "9px", display: "flex",flexDirection:'row' }}>
      <div
        onClick={() => {
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-start", alignItems: 'center' }} >
          ...
          <div className="text-left lead docName" style={{ fontWeight: 600,fontSize:13, overflow: "hidden", textOverflow: 'ellipsis' }} >
