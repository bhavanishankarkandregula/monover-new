...
console.log("filesffffffil",file)
  ...
  return (
    <div style={{marginLeft:'8px',width:'378px',marginRight:'4px',flexDirection:'row',backgroundColor: "rgba(243, 242, 242, 0.7)", height: "53px", border: "1px solid lightgrey", borderRadius: "9px", display: "flex", alignItems: "center" }}>
      <div
        onClick={() => {
