...
function FilePreview(props) {
  ...
  const FileIcon = () => {
    if (extension === "jpg" || extension === "jpeg" || extension === "png")
      return <img src={filePath} width={110} height={90} alt="file" />;
    else if (extension === "pdf")
      return <img src={PdfIcon} width={100} height={90} alt="file" />;
    else if (extension === "doc" || extension === "docx")
      return <img src={WordIcon} width={100} height={90} alt="file" />;
    else if (extension === "txt")
      return <img src={TextIcon} width={100} height={90} alt="file" />;
    return <img src={InvalidIcon} width={100} height={90} alt="file" />;
  };
    ...
    <div>
      ...
      >
        ...
        <div
          ...
          className="pr-1 pr-md-3"
        >
          <AiFillEye style={{ cursor: "pointer", fontSize: "24px" }} />
        </div>
        <div />
        <div
