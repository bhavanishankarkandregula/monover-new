...
import { AiFillEye, AiOutlineFileJpg, GrDocumentPdf,TiArrowForward } from "react-icons/all";
...
console.log("filesffffffil",file)
  ...
  return (
    <div style={{marginLeft:'8px',width:'385px',marginRight:'4px',flexDirection:'row',backgroundColor: "rgba(243, 242, 242, 0.7)", height: "53px", border: "1px solid lightgrey", borderRadius: "9px", display: "flex", alignItems: "center" }}>
      <div
        onClick={() => {
      ...
      <TiArrowForward     fontSize="21px"
          className=""
          style={{ cursor: "pointer",marginRight:'6px',marginTop:'1px' }}
          onClick={(e) => {
            setLink(filePath);
            openModal(e);
          }} />
        <AiFillEye
          ...
          style={{ cursor: "pointer",marginRight:'13px',marginTop:'2px'  }}
          onClick={(e) => {
            setLink(filePath);
            openModal(e);
          }}
