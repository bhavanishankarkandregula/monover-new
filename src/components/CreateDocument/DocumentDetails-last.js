  ...
  async function documentDetailsApi3() {
    await axios
      ...
      .then((res) => {
        ...
        console.log("GOODDFFGGFFDDSS 0,1:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields[0].LabelDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,1:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields[0].ValueDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,2:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields[1].LabelDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,2:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields[1].ValueDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,3:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields[2].LabelDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,3:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields[2].ValueDetection.Text)
        
        console.log("-------------------------------------------")
        console.log("GOODDFFGGFFDDSS 0,1:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[1].LineItemExpenseFields[0].LabelDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,1:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[1].LineItemExpenseFields[0].ValueDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,2:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[1].LineItemExpenseFields[1].LabelDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,2:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[1].LineItemExpenseFields[1].ValueDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,3:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[1].LineItemExpenseFields[2].LabelDetection.Text)
        console.log("GOODDFFGGFFDDSS 0,3:",res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems[1].LineItemExpenseFields[2].ValueDetection.Text)


        let arrHeadings = res.data.document_content?.ExpenseDocuments[0].LineItemGroups[0].LineItems[0].LineItemExpenseFields.map(row =>{  return row.LabelDetection?.Text})
        arrHeadings = arrHeadings.filter(head => head!==undefined)
        const arrRows = res.data.document_content.ExpenseDocuments[0].LineItemGroups[0].LineItems
          // tableExists, tableHeads, tableRows
        if(arrHeadings.length>0){
            setTableHeads(arrHeadings)
            setTableRows(arrRows)
            setTableExists(true)
          }
        console.log("AAAAAAAAAAAAAAAARRRY: ", arrHeadings)
        // used_template_id
              ...
              <div className="flex-column">
                {tableExists && (
                  <table border="1"  width="100%">
                    <tr>
                    {tableHeads.map((head)=><td>{head}</td>) }
                    </tr>
                    {tableRows.map(tableRow => <tr>
                      {tableRow.LineItemExpenseFields.map(colm => {
                      if(colm.LabelDetection?.Text!==undefined){
                      return (<td>{colm.ValueDetection.Text}</td>)
                      }
                      })
